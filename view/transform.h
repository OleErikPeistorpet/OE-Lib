...
* Moreover, the function does not need to model std::regular_invocable, meaning it's all right to return
* different results for the same input, as long as the call operator is not const (like mutable lambda).
