...
struct _iterMoveFriendTransformIter
{
	...
	template< typename I >
	friend constexpr decltype(auto) iter_move(const _iterTransformIterator<oelIterMove_::Fn, I> & it)
...
public:
	...
	friend constexpr bool operator!=
		(const _iterTransformIterator & left, const _iterTransformIterator & right)   { return left.m.first != right.m.first; }
	friend constexpr bool operator <
		(const _iterTransformIterator & left, const _iterTransformIterator & right)   { return left.m.first < right.m.first; }
